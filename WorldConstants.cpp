...
namespace WorldConstants
{
	...
	const int PLAYER_COLOUR = 0xFF0000;		//255, 0, 0
	const int NPC_COLOUR = 0x0000FF;		//0, 0, 255
	...
	{
		LevelData(LEVEL_ONE_CHAR_SPAWN_WIDTH  ,   LEVEL_ONE_LENGTH   , LEVEL_ONE_WALLS   , LEVEL_ONE_TOUCHING_WALLS),
		LevelData(LEVEL_TWO_CHAR_SPAWN_WIDTH  ,   LEVEL_TWO_LENGTH   , LEVEL_TWO_WALLS   , LEVEL_TWO_TOUCHING_WALLS),
		LevelData(LEVEL_THREE_CHAR_SPAWN_WIDTH,   LEVEL_THREE_LENGTH , LEVEL_THREE_WALLS , LEVEL_THREE_TOUCHING_WALLS)
	};
}